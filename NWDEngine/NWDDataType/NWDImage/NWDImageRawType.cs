...
namespace NetWorkedData
{
	...
	[SerializeField]
	//-------------------------------------------------------------------------------------------------------------
	public class NWDImageRawType : NWDAssetType
	{
		//-------------------------------------------------------------------------------------------------------------
		public NWDImageRawType ()
		{
			Value = "";
		}
		//-------------------------------------------------------------------------------------------------------------
		public NWDImageRawType (string sValue = "")
		{
			if (sValue == null) {
				Value = "";
			} else {
			...
			if (Value != null && Value != "") {
				try {
					...
					if (tDecodedBytes != null) {
						...
						tTexture.LoadRawTextureData (tDecodedBytes);
						tTexture.Apply();
						return tTexture;
					} else {
						return null;   
		...
		{
			if (sTexture != null) {
				byte[] tByteOfPicture = sTexture.GetRawTextureData ();
		...
		{
			NWDImageRawType tTemporary = new NWDImageRawType ();

...
namespace NetWorkedData
{
	...
	[SerializeField]
	//-------------------------------------------------------------------------------------------------------------
	public class NWDImageEXRType : NWDAssetType
	{
		//-------------------------------------------------------------------------------------------------------------
		public NWDImageEXRType ()
		{
			Value = "";
		}
		//-------------------------------------------------------------------------------------------------------------
		public NWDImageEXRType (string sValue = "")
		{
			if (sValue == null) {
				Value = "";
			} else {
		...
		{
			if (sTexture != null) {
				// test format ? sTexture.format == TextureFormat
				byte[] tByteOfPicture = sTexture.EncodeToEXR (Texture2D.EXRFlags.CompressZIP);

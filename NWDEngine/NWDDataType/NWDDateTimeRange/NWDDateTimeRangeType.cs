...
//			float tTiersWidthC = tTiersWidth - NWDConstants.kFieldMarge * 3;
			...
			int tYearStart = 1900 + EditorGUI.Popup (new Rect (tX, sPos.y + tHeightAdd, tWidthYear, sPos.height),
				                 tStartDateTimes.Year - 1900, NWDDateTimeType.kYears);
			...
			if (tDayNumberStart == 31) {
				tDayStart = 1 + EditorGUI.Popup (new Rect (tX + tWidthYear + tWidthMonth + NWDConstants.kFieldMarge * 2, sPos.y + tHeightAdd, tWidthDay, sPos.height),
			...
			int tYearNext = 1900 + EditorGUI.Popup (new Rect (tX, sPos.y + tHeightAdd, tWidthYear, sPos.height),
				                tEndDateTimes.Year - 1900, NWDDateTimeType.kYears);
			...
			int tDayNumberNext = DateTime.DaysInMonth (tYearStart, tMonthStart);

			int tDayNext = 1;
			if (tDayNumberNext == 31) {
				tDayNext = 1 + EditorGUI.Popup (new Rect (tX + tWidthYear + tWidthMonth + NWDConstants.kFieldMarge * 2, sPos.y + tHeightAdd, tWidthDay, sPos.height),

...
namespace NetWorkedData
{
	...
	public class NWDDateTimeUtcType : BTBDataType
	{
        ...
        {
            SetDateTime(DateTime.Now.ToUniversalTime());
        }
        //-------------------------------------------------------------------------------------------------------------
...
//			float tTiersWidthC = tTiersWidth - NWDConstants.kFieldMarge*3;
            ...
            tYear = NWDDateTimeUtcType.kYearStart+ EditorGUI.Popup (new Rect (tX+30, sPos.y + tHeightAdd, tWidthYear-30, NWDConstants.kPopupdStyle.fixedHeight),
                                                                 tDateTime.Year - NWDDateTimeUtcType.kYearStart, NWDDateTimeUtcType.kYears);
            ...
            tMonth = 1+ EditorGUI.Popup (new Rect (tX+tWidthYear +NWDConstants.kFieldMarge, sPos.y + tHeightAdd, tWidthMonth, NWDConstants.kPopupdStyle.fixedHeight),
				tDateTime.Month-1, NWDDateTimeUtcType.kMonths);
			...
			if (tDayNumber == 31 )
			{
                tDay = 1+ EditorGUI.Popup (new Rect (tX+tWidthYear +tWidthMonth+NWDConstants.kFieldMarge*2, sPos.y + tHeightAdd, tWidthDay, NWDConstants.kPopupdStyle.fixedHeight),
					tDateTime.Day-1, NWDDateTimeUtcType.kDays);
			}
			else if (tDayNumber == 30)
			{
                tDay = 1+ EditorGUI.Popup (new Rect (tX+tWidthYear +tWidthMonth+NWDConstants.kFieldMarge*2, sPos.y + tHeightAdd, tWidthDay, NWDConstants.kPopupdStyle.fixedHeight),
					tDateTime.Day-1, NWDDateTimeUtcType.kDaysB);
			}
			else if (tDayNumber == 28)
			{
                tDay = 1+ EditorGUI.Popup (new Rect (tX+tWidthYear +tWidthMonth+NWDConstants.kFieldMarge*2, sPos.y + tHeightAdd, tWidthDay, NWDConstants.kPopupdStyle.fixedHeight),
					tDateTime.Day-1, NWDDateTimeUtcType.kDaysC);
			}
			else if (tDayNumber == 29)
			{
                tDay = 1+ EditorGUI.Popup (new Rect (tX+tWidthYear +tWidthMonth+NWDConstants.kFieldMarge*2, sPos.y + tHeightAdd, tWidthDay, NWDConstants.kPopupdStyle.fixedHeight),
					tDateTime.Day-1, NWDDateTimeUtcType.kDaysD);
			}

...
namespace NetWorkedData.NWDEditor
{
    ...
    public abstract class NWDEditorMenu
    {
        ...
        const string K_MODELS = "Create Models/";
        ...
        //-------------------------------------------------------------------------------------------------------------
        [MenuItem(K_NETWORKEDDATA + K_MODELS + "Models manager", false, 185)]
        public static void ModelsManager()
        {
            NWDModelManager.SharedInstanceFocus();
        }
        //-------------------------------------------------------------------------------------------------------------
        [MenuItem(K_NETWORKEDDATA + K_MODELS + "Nodal view", false, 192)]
        ...
        #region Tools
        //-------------------------------------------------------------------------------------------------------------
        [MenuItem(K_NETWORKEDDATA + K_TOOLS + "Password Analyze", false, 200)]

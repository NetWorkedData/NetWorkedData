...
namespace NetWorkedData
{
    ...
    public partial class NWDAppEnvironment
    {
        ...
        public void DrawInEditor(EditorWindow sEditorWindow)
        {
            ...
            NWDGUILayout.SubTitle("AppName for server action " + Environment);
            ...
            NWDGUILayout.SubTitle("Security of Datas" + Environment);
            ...
            NWDGUILayout.SubTitle("Hash of Datas" + Environment);
            ...
            NWDGUILayout.SubTitle("Network Ping tester " + Environment);
            AddressPing = EditorGUILayout.TextField("Address Ping (8.8.8.8)", AddressPing);

            NWDGUILayout.SubTitle("Server Params for " + Environment);
            ...
            NWDGUILayout.SubTitle("SFTP for " + Environment);
            ...
            NWDGUILayout.SubTitle("Email to send forgotten code " + Environment);
            RescueEmail = EditorGUILayout.TextField("RescueEmail", RescueEmail);
            NWDGUILayout.SubTitle("Mail Params for " + Environment);
            ...
            NWDGUILayout.SubTitle("Social Params for " + Environment);
            ...
            NWDGUILayout.SubTitle("SQL Thread Activation " + Environment);
            ...
            NWDGUILayout.SubTitle("Last Build infos " + Environment);

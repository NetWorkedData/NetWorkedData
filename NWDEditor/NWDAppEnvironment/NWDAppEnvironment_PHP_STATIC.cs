...
namespace NetWorkedData
{
    ...
    public partial class NWDAppEnvironment
    {
        ...
        private void CreatePHP_StaticAccountFile(Dictionary<string, string> sFilesAndDatas, bool sWriteOnDisk = true)
        {
            ...
            tFile.AppendLine("{");
            tFile.AppendLine("myLog('error in mysqli request : ('. $SQL_CON->errno.')'. $SQL_CON->error.' in : '.$tQuerySign.'', __FILE__, __FUNCTION__, __LINE__);");
            ...
            tFile.AppendLine("$tQuery = 'SELECT `"+tReference+"`, `"+tBan+"` FROM `'.$ENV.'_"+NWDAccount.BasisHelper().ClassNamePHP+"` WHERE `"+tReference+"` = \\''.$SQL_CON->real_escape_string($tRowSign['"+tSignAccountKey+"']).'\\' AND `"+tAC+"` = 1;';");
        ...
        private void CreatePHP_StaticFunctionsFile(Dictionary<string, string> sFilesAndDatas, bool sWriteOnDisk = true)
        {
            ...
            tFile.AppendLine("$tInsertSQL.='`SecretKey`, '; $tInsertSQLValue.= '\\''.$SQL_CON->real_escape_string($shs).'\\', ';");

...
namespace NetWorkedData
{
    ...
    public partial class NWDAppEnvironment
    {
        ...
        private void CreatePHP_StaticAccountFile(Dictionary<string, string> sFilesAndDatas, bool sWriteOnDisk = true)
        {
            ...
            tFile.AppendLine("$ereg_action = '/^(rescue|session|signin|signup|signout|modify|reinitialize|delete|facebook|twitter|google|unity|joker|google_remove|facebook_remove)$/';");
        ...
        private void CreatePHP_StaticFunctionsFile(Dictionary<string, string> sFilesAndDatas, bool sWriteOnDisk = true)
        {
            ...
            tFile.AppendLine("global $tNewSecretKey, $ereg_token;");
            tFile.AppendLine("global $SQL_CON;");
            ...
            tFile.AppendLine("{");
            tFile.AppendLine("if (paramValue ('tNewSecretKey', 'shs', '/^(.{24,64})$/', 'SHS01', 'SHS02'))");
            tFile.AppendLine("{");
            ...
            tFile.AppendLine("else");
            tFile.AppendLine("{");
            tFile.AppendLine("myLog('Error shs = '.$tNewSecretKey, __FILE__, __FUNCTION__, __LINE__);");

...
namespace NetWorkedData.NWDEditor
{
    ...
    public class NWDEditorNewExtension : NWDEditorWindow
    {
        ...
        {
            return NWDConstants.K_NWDURL + "editor-new-extension/";
        }
        //-------------------------------------------------------------------------------------------------------------
        /// <summary>
        /// The Shared Instance.
        ...
        public static NWDEditorNewExtension SharedInstance()
        {
            ...
            {
                _kSharedInstance = EditorWindow.GetWindow(typeof(NWDEditorNewExtension), ShowAsWindow()) as NWDEditorNewExtension;
            }
            NWDBenchmark.Finish();

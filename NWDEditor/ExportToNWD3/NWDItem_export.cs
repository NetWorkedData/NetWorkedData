    ...
    public partial class NWDItem : NWDBasis
    {
        ...
        public override List<NWDExportObject> ExportNWD3()
        {
            ...
            var tExport = new {
                ...
                Sprites = NWDExportObject.ProcessNewAsset(tSprites, "NWDSpriteAsset"),
                Textures = NWDExportObject.ProcessNewAsset(tTextures, "NWDTextureAsset"),
                Colors = NWDExportObject.ProcessNewColor(tColors),
                Prefabs = NWDExportObject.ProcessNewAsset(tPrefabs, "NWDPrefabAsset"),
                EffectPrefab = NWDExportObject.ProcessNewAsset(EffectPrefab, "NWDPrefabAsset"),

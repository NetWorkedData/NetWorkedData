...
namespace NetWorkedData
{
    ...
    public partial class NWDSharedAccountServicesHelper : NWDHelper<NWDSharedAccountServices>
    {
        ...
        {
            //NWDError.CreateGenericError(ClassNamePHP, ClassTrigramme + "01", "your error 01", "your description", "OK", NWDErrorType.InGame, NWDBasisAccountSharedTag.TagInternal);
        }
#endif
        //-------------------------------------------------------------------------------------------------------------
        ...
        public override List<Type>  OverrideClasseInThisSync()
        {
            ...
            {
                typeof(NWDSharedAccountServices),
                //typeof(NWDOtehrType),
            };
        }
        //-------------------------------------------------------------------------------------------------------------

    ...
    public partial class NWDServerOther : NWDServer
    {
        ...
        public override void AddonEditor(Rect sRect)
        {
            ...
            if (NWDProjectCredentialsManager.IsValid(NWDCredentialsRequired.ForSFTPGenerate))
            {
                ...
                "mkdir /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _NoSSL,
                "echo $\"<?php echo phpinfo();?>\" > /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _NoSSL+ "/phpinfo.php",
                "echo $\"Hello " + WebDomainNameServer + ", please use SSL connexion!\" > /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _NoSSL+ "/index.html",
                "chown -R " + WebDomainNameUser + ":www-data /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _NoSSL+ "",
                "chmod -R 750 /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _NoSSL+ "",

                "mkdir /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _SSL+ "",
                "echo $\"<?php echo phpinfo();?>\" > /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _SSL+ "/phpinfo.php",
                "echo $\"Hello " + WebDomainNameServer + ", you are secure!\" > /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _SSL+ "/index.html",
                "chown -R " + WebDomainNameUser + ":www-data /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _SSL+ "",
                "chmod -R 750 /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _SSL+ "",
                ...
                "sed -i '$ a ServerAlias " + WebDomainNameServer + "' /etc/apache2/sites-available/" + WebDomainNameServer + _NoSSL+"_ws.conf",
                "sed -i '$ a DocumentRoot /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _NoSSL+ "' /etc/apache2/sites-available/" + WebDomainNameServer + _NoSSL+"_ws.conf",
                ...
                "sed -i '$ a </Directory>' /etc/apache2/sites-available/" + WebDomainNameServer + _NoSSL+"_ws.conf",
                "sed -i '$ a <Directory /home/" + WebDomainNameUser + "/" + WebDomainNameFolder + _NoSSL + ">' /etc/apache2/sites-available/" + WebDomainNameServer + _NoSSL+"_ws.conf",
                ...
                "sed -i '$ a ServerAlias " + WebDomainNameServer+ "' /etc/apache2/sites-available/" + WebDomainNameServer +  _SSL +"_ws.conf",
                "sed -i '$ a DocumentRoot /home/" + WebDomainNameUser + "/" + WebDomainNameFolder  + _SSL+ "' /etc/apache2/sites-available/" + WebDomainNameServer +  _SSL +"_ws.conf",
                ...
                "sed -i '$ a </Directory>' /etc/apache2/sites-available/" + WebDomainNameServer +  _SSL +"_ws.conf",
                "sed -i '$ a <Directory /home/" + WebDomainNameUser + "/" + WebDomainNameFolder  + _SSL+ ">' /etc/apache2/sites-available/" + WebDomainNameServer +  _SSL +"_ws.conf",

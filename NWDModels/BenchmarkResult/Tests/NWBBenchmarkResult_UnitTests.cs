...
namespace NWDEditorTests
{
    ...
    public partial class NWBBenchmarkResult_UnitTests : NWDClassTest
    {
        ...
        public void Test_NewData()
        {
            ...
            NWBBenchmarkResult tItemA = NWDUnitTests.NewLocalData<NWBBenchmarkResult>();
            NWBBenchmarkResult tItemB = NWDUnitTests.NewLocalData<NWBBenchmarkResult>();
        ...
        public void Test_Duplicate()
        {
            ...
            NWBBenchmarkResult tItemA = NWDUnitTests.NewLocalData<NWBBenchmarkResult>();
            tItemA.UpdateData();
            NWBBenchmarkResult tItemB = NWDBasisHelper.DuplicateData(tItemA);
            Assert.AreNotEqual(tItemA.Reference, tItemB.Reference);
            NWDUnitTests.CleanUnitTests(); // clean environment after
        }
        //-------------------------------------------------------------------------------------------------------------

...
namespace NetWorkedData
{
    ...
    {
        //-------------------------------------------------------------------------------------------------------------
        static protected NWDIndex<NWDLevel, GNCSeed> kLevelIndex = new NWDIndex<NWDLevel, GNCSeed>();
        //-------------------------------------------------------------------------------------------------------------
        [NWDIndexInMemory]
        ...
        //-------------------------------------------------------------------------------------------------------------
        public static GNCSeed FindFirstDataBySomething(NWDLevel sKey, bool sOrCreate = false)
        {
            GNCSeed rReturn = kLevelIndex.FirstRawDataByKey(sKey.Reference);

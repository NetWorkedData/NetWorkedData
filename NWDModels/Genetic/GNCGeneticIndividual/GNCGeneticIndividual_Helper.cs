...
namespace NetWorkedData
{
    ...
    public partial class GNCGeneticIndividualHelper : NWDHelper<GNCGeneticIndividual>
    {
        ...
        {
            //NWDError.CreateGenericError(ClassNamePHP, ClassTrigramme + "01", "your error 01", "your description", "OK", NWDErrorType.InGame, NWDBasisGameSaveDependentTag.TagInternal);
        }
#endif
        //-------------------------------------------------------------------------------------------------------------

...
namespace NetWorkedData
{
    ...
    public class AIRAverage
    {
        ...
        public AIRAverage(string sString)
        {
            ...
            {
                float.TryParse(tValueArray[5], out SurfaceWeighting);
            }
        }
        //-------------------------------------------------------------------------------------------------------------
        new public string ToString()
        {
            return Intolerance.ToString("F5") + NWDConstants.kFieldSeparatorC +
                   ...
                   Jealousy.ToString("F5") + NWDConstants.kFieldSeparatorC +
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    /// <summary>
    /// AIRAverage used to put a reference in value. Use properties with simple, like 'AccountAIRAverage', 'SpotAIRAverage', 'BonusAIRAverage' , etc.
    /// </summary>
    [SerializeField]

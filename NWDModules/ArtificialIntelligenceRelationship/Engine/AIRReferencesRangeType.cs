...
namespace NetWorkedData
{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    /// <summary>
    /// AIR AIRRange used to put a reference in value but by Hash. Use properties with simple name, like 'AccountAIRAverage', 'SpotAIRAverage', 'BonusAIRAverage' , etc.
    /// </summary>
    public class AIRRange
    {
        //-------------------------------------------------------------------------------------------------------------
        public float SurfaceWeighting;
        //-------------------------------------------------------------------------------------------------------------
        ...
        public AIRRange(string sString)
        {
            ...
            {
                float.TryParse(tValueArray[2], out SurfaceWeighting);
            }
        }
        //-------------------------------------------------------------------------------------------------------------
        new public string ToString()
        {
            return Min.ToString() + NWDConstants.kFieldSeparatorC +
                   Max.ToString() + NWDConstants.kFieldSeparatorC +
                   SurfaceWeighting.ToString("F5");
        }
        //-------------------------------------------------------------------------------------------------------------
    }
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

...
namespace SpiritOfBottle
{
    ...
    public class PanelQuestTracker : MonoBehaviour
    {
        ...
        void InitQuestTracker()
        {
            ...
            //NWDUserQuestAdvancement[] tQuests = NWDUserQuestAdvancement.GetAllObjects();
            // NWD Version 2
            NWDUserQuestAdvancement[] tQuests = NWDUserQuestAdvancement.FindDatas();
            foreach (NWDUserQuestAdvancement tQuest in tQuests)
            {

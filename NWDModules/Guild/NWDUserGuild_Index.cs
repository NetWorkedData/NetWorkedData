...
namespace NetWorkedData
{
    ...
    public partial class NWDUserGuild : NWDBasis<NWDUserGuild>
    {
                ...
                && TestIntegrity() == true)
            {
                ...
                if (kIndexList != null)
                {
                    ...
                    else
                    {
                        kIndexList.Remove(this);
                        kIndexList = null;
                        kIndexList = new List<NWDUserGuild>();
        ...
        //-------------------------------------------------------------------------------------------------------------
        static public List<NWDUserGuild> FindByIndex(NWDGuildPlace sSomething)
        {
            List<NWDUserGuild> rReturn = null;
            if (sSomething != null)
            {
        ...
        //-------------------------------------------------------------------------------------------------------------
        static public List<NWDUserGuild> FindByIndex(string sSomething)
        {
            List<NWDUserGuild> rReturn = null;
            if (sSomething != null)
            {
        ...
        //-------------------------------------------------------------------------------------------------------------
        static public NWDUserGuild FindFirstByIndex(string sSomething)
        {
            NWDUserGuild rObject = null;
            List<NWDUserGuild> rReturn = null;
            if (sSomething != null)
            {
                string tKey = sSomething;

...
namespace NetWorkedData
{
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    public class NWDDialog
    {
        //-------------------------------------------------------------------------------------------------------------
        const string K_OK = "YES";
        const string K_NOK = "NO";
        //-------------------------------------------------------------------------------------------------------------
        public static NWDDialog Dialog(NWDMessage sMessage, NWDDialogOnCompleteBlock sCompleteBlock = null)
        {
            NWDDialog rDialog = new NWDDialog(
        ...
        //-------------------------------------------------------------------------------------------------------------
        public static NWDDialog Dialog(string sTitle, string sMessage, string sOK = K_OK, string sNOK = K_NOK, NWDDialogOnCompleteBlock sCompleteBlock = null)
        {
            NWDDialog rDialog = new NWDDialog(sTitle, sMessage, sOK, sNOK, sCompleteBlock);
            return rDialog;
        }
        //-------------------------------------------------------------------------------------------------------------
        public NWDDialog(string sTitle, string sMessage, string sOK = K_OK, string sNOK = K_NOK)
        {
            Initialization(sTitle, sMessage, sOK, sNOK, null);
        }
        //-------------------------------------------------------------------------------------------------------------
        public NWDDialog(string sTitle, string sMessage, string sOK, string sNOK, NWDDialogOnCompleteBlock sCompleteBlock = null)
        {
